...
//  val CPUS_PER_TASK = conf.getInt("spark.task.cpus", 1)
  ...
  override def executorHeartbeatReceived(
    ...
    if(!taskMetrics.isEmpty && taskMetrics.head._2.executorMetrics.isDefined) {
      executorIdToExMetrics.put(execId, taskMetrics.head._2.executorMetrics.get)
    }
